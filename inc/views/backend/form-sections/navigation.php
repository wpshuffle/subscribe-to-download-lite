<div class="stdl-form-nav-wrap">
    <ul class="stdl-form-nav">
        <li><a href="javascript:void(0);" class="stdl-nav-item stdl-active-nav" data-tab="general"><span class="dashicons dashicons-admin-generic"></span><?php esc_html_e('General Settings', 'subscribe-to-download-lite'); ?></a></li>
