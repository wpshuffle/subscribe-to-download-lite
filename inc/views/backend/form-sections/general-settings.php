<div class="stdl-settings-each-section" data-tab="general">
    ...
    <div class="stdl-field-wrap stdl-download-button" <?php $this->display_none($always_show, 0); ?>>
        ...
        <div class="stdl-field">
            <input type="text" name="form_details[general][download_button_text]" placeholder="<?php esc_html_e('Download', 'subscribe-to-download-lite'); ?>" value="<?php echo (!empty($form_details['general']['download_button_text'])) ? esc_attr($form_details['general']['download_button_text']) : ''; ?>"/>
